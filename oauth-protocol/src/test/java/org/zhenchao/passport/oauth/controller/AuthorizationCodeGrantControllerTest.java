...
import org.zhenchao.passport.oauth.enums.GrantType;
...
public class AuthorizationCodeGrantControllerTest implements RequestPath {
    ...
    public void requestAccessTokenWithErrorGrantTypeTest() throws Exception {
        ...
        Assert.assertEquals(ErrorCode.UNSUPPORTED_GRANT_TYPE.getCode(), json.getIntValue("code"));
    }
    ...
    public void requestAccessTokenWithErrorCodeTest() throws Exception {
        ...
        response = RestAssured.with().params(params).get(PATH_OAUTH_AUTHORIZE_TOKEN);
        JSONObject json = JSONObject.parseObject(response.asString());
        Assert.assertEquals(ErrorCode.INVALID_AUTHORIZATION_CODE.getCode(), json.getIntValue("code"));
    }
    ...
    public void requestAccessTokenWithErrorRedirectUriTest() throws Exception {
        ...
        response = RestAssured.with().params(params).get(PATH_OAUTH_AUTHORIZE_TOKEN);
        JSONObject json = JSONObject.parseObject(response.asString());
        Assert.assertEquals(ErrorCode.INVALID_GRANT.getCode(), json.getIntValue("code"));
    }
    ...
    public void requestAccessTokenWithErrorClientIdTest() throws Exception {
        ...
        response = RestAssured.with().params(params).get(PATH_OAUTH_AUTHORIZE_TOKEN);
        JSONObject json = JSONObject.parseObject(response.asString());
        Assert.assertEquals(ErrorCode.UNAUTHORIZED_CLIENT.getCode(), json.getIntValue("code"));
    }
